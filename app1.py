...
def product_description(selected_product):
    if selected_product == "American Tourister Bag":
        ...
        st.markdown(
            ...
            **Specifications**  
            ...
            ---  
            [See More](https://americantourister.com)  <!-- Replace the link with your desired URL -->
    ...
    if selected_product == "Iphone 15 Pro":
        ...
        st.markdown(
            ...
            **Battery Life**  
            ...
            ---  
            [See More](https://apple.com)  <!-- Replace the link with your desired URL -->
    ...
    if selected_product == "Refrigerator (Samsung)":
        ...
        st.markdown(
            ...
            **Additional Information**  
            ...
            ---  
            [See More](https://Samsung.com)  <!-- Replace the link with your desired URL -->
...
def product_list():
    ...
    folder_path = "D:\FYP\Product\products\products"
...
def home():
    st.title("")
    st.markdown("<h1 style='text-align: center; color: yellow;'>Product Rating System</h1>", unsafe_allow_html=True)
    ...
    st.markdown("<span style='text-align: center; color: white;'>Write Review : Go to the Review section to put your review about the products</span>",unsafe_allow_html=True)
    st.markdown("<span style='text-align: center; color: white;'>This is a Team project done by Batch 17</span>", unsafe_allow_html=True)
    page_element="""
    <style>
    [data-testid="stAppViewContainer"]{
    background-image: url("https://www.wallpapertip.com/wmimgs/83-838362_web-developer.jpg");
